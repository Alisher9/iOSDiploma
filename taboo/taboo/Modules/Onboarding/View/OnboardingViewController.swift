...
//        Asset.Onboarding.onboarding1.image,
//        Asset.Onboarding.onboarding2.image,
//        Asset.Onboarding.onboarding3.image
//    ]
//
...
//        button.layer.borderColor = ColorName.mainGreen.color.cgColor
//        button.layer.masksToBounds = true
//        button.setTitleColor(ColorName.mainGreen.color, for: .normal)
...
//                self.nextButton.backgroundColor = ColorName.mainGreen.color
//            })
//
//        } else {
//            UIView.animate(withDuration: 0.3, animations: {
//                self.nextButton.setTitle(L10n.Onboarding.next, for: .normal)
//                self.nextButton.setTitleColor(ColorName.mainGreen.color, for: .normal)
